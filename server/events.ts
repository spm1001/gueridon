...
export type BridgeEvent =
  ...
  | { type: "turn:complete"; folder: string; sessionId: string; durationMs: number; inputTokens: number | null; outputTokens: number | null; contextPct: number | null; toolCalls: number; subagentFiltered?: number; sseBytes?: Record<string, number> }
