// Vendored from pi-mono/packages/web-ui/src/components/ThinkingBlock.ts
// Commit: 41c4157b (2026-02-09)
// Import path rewrite: none needed (only imports from npm packages)
//
// Note: upstream uses @customElement decorator. We keep it but also guard
// with customElements.get() for consistency with other vendored files.
