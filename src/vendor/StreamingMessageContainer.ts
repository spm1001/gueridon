// Vendored from pi-mono/packages/web-ui/src/components/StreamingMessageContainer.ts
...
export class StreamingMessageContainer extends LitElement {
	...
	override render() {
		...
		if (msg.role === "toolResult") {
			...
			// Skip standalone tool result in streaming; the stable list will render it immediately
			return html``;
